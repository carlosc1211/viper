...
$tit1 = "Daily Logs";
$tit2 = "Edit Daily Log";
$url1 = "daily_log.php?co_acc=$co_acc";
$url2 = "daily_log_edit.php?co_acc=$co_acc&co=$codigo";
?>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($_REQUEST["acc"]))
                                {
                                    ...
                                    {
                                        $result = $dailymod->eliminar(["co"=>$codigo]);
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label" for="r_employee">Clock In</label>
                                            <div id="map_in" style="height: 100%"></div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group ">
                                            <label class="control-label" for="r_employee">Clock Out</label>
                                            <div id="map_out" style="height: 100%"></div>
                                        </div>
                                    </div>
