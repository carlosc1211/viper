...
$url2 = "perfil-new.php?co_acc=$co_acc";
?>
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div class="col-md-10">
                                            ...
                                            <select name="accesos_asgn" size="5" class="form-control" id="accesos_asgn"></select>
                                            <input type="hidden" id="accesos_asgn_add" name="accesos_asgn_add">
                                        </div>
                                    </div>
