...
$url3 = "issue-edit.php";
$url4 = "issue-list-print.php";
$url5 = "issue-list-pdf.php";
$url6 = "issue-list-excel.php";
                            ...
                            {	?>
                                <table id="example" class="table table-striped responsive-utilities jambo_table">
                                    ...
                                    <tr class="even pointer">
                                        ...
                                        <td class=" last"><a href="<?php echo $url3;?>?co=<?php echo $co;?>&amp;co_acc=<?php echo $co_acc ;?>" class="btn btn-default load"><i class="fa fa-search"></i> View</a>
                                        </td>
                                    </tr>
                                    <?php
                                    }
