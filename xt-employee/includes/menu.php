...
<div class="left_col scroll-view">
    ...
    <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
        ...
        <div class="menu_section">
            <ul class="nav side-menu">
                <li><a href="../main/findex.php" class="load"><i class="fa fa-home"></i> Main</a>
                    <?php

                    $menumodel = new MenuModel();
                    $usuariomodel = new UsuarioModel();

                    $rs = $menumodel -> MenuRol($db, 2);

                    foreach($rs as $rss)
                    {	extract($rss);
                    ?>
                        <li><a><?php echo $icon ?> <?php echo $nb ?> <span class="fa fa-chevron-down"></span></a>
                        <ul class="nav child_menu" style="display: none">
                        
                        <?php
                        $rs = $menumodel->MenuModulosEmployee($db, $co, 2);
                ...
                <li><a href="../post/library-list.php" class="load"><i class="fa fa-book"></i> Post Library</a>
    ...
    <div class="sidebar-footer hidden-small">
        ...
        <a href="../user/user-edit.php?co=<?php echo $_SESSION["codemployee"]["co"]?>&co_acc=5" data-toggle="tooltip" data-placement="top" title="Profile">
