                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($_REQUEST["acc"]))
                                {
                                    if(getA("acc")=="ing")
                                    {
                                        $result = $maintenance->ingresar($db,
                                            [
                                                "ds_dir"=>getA("_dir"),
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                <div class="form-group col-md-6 col-xs-12">
                                                    ...
                                                    <input type="text" class="form-control" name="r_title" id="r_title" placeholder="Input Title" maxlength="250">
                                                </div>
                                                ...
                                                <div class="form-group col-md-12 col-xs-12">
                                                    <label class="control-label" for="ds">Resume</label>
                                                    <textarea class="form-control" name="ds" id="ds" placeholder="Input Resume" ></textarea>
                                                </div>
