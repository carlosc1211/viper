                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="x_panel">
                            <form role="form" action="#">
                                <div class="col-md-12 col-xs-12">
                                    <br><br><br>
                                    <div  class="alert alert-success" role="alert"><i class="fa fa-check-circle-o" style="font-size: 24px"></i> Check <?php echo $titcomp ?> Updated</div>
                                    <br><br>
                                    <?php if($titcomp=="In") { ?>
                                    <button class="btn btn-info col-md-6 col-xs-12" type="button" onclick="javasscript:location.href='tracker-activity.php'"><i class="fa fa-map-marker"></i> Proceed to Tracker Activity</button>
                                    <?php } ?>
