                                            ...
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="r_co_device" class="form-control" id="r_co_device" readonly>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="r_co_post" class="form-control" id="r_co_post" readonly>
                                                            <option value="" selected>Select</option>
                                                            <?php
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class='input-group date' id='datetimepicker1'>
                                                            <input type='text' class="form-control" name="r_fe_report" readonly id="r_fe_report" value="<?php echo $fe_report ?>" />
                                                ...
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <textarea class="form-control" name="ds" id="ds" readonly placeholder="Input Description" ><?php echo $ds?></textarea>
                                                </div>
