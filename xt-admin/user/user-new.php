                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($_REQUEST["acc"]))
                                {
                                    if(getA("acc")=="ing")
                                    {
                                        $result = $usuario->ingresar($db,
                                            ["nb"=>getA("r_nombre"),
                                             "apll"=>getA("r_apellido"),
                                             "company"=>getA("r_company"),
                                             "telf"=>getA("telefono"),
                                             "corr"=>getA("r_correo"),
                                             "usr"=>getA("r_usuario"),
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="r_nombre" id="r_nombre" placeholder="Input First Name" maxlength="50">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="r_apellido">Last Name</label>
                                        <input type="text" class="form-control" name="r_apellido" id="r_apellido" placeholder="Input Last Name" maxlength="50">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="r_company">Company</label>
                                        <input type="text" class="form-control" name="r_company" id="r_company" placeholder="Input Company" maxlength="70">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="telefono">Phone</label>
                                        <input type="text" class="form-control" name="telefono" id="telefono" placeholder="Input Phone" maxlength="70">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="r_nombre">Email</label>
                                        <input type="text" class="form-control" name="r_correo" id="r_correo" placeholder="Input Email" maxlength="150" onBlur="javascript:validaemail2('forma','r_correo')" data-placement="bottom" data-content="Coloque un email valido">
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <div id="divAccUser" class="col-md-12"></div>
                                    </div>
                                    <hr>
                                    <div class="form-group ">
                                        <label class="control-label" for="perfil">User</label>
                                        <input name="r_usuario" type="text" class="form-control" id="r_usuario"  maxlength="10" onBlur="javascript:verif_usr()">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="perfil">Password</label>
                                        <input name="r_clave" type="password" class="form-control" id="r_clave"  maxlength="10">
                                    </div>
                                    <div class="form-group ">
