...
$tit2 = "New Maintenance Type";
$url1 = "maintenance-type.php?co_acc=$co_acc";
$url2 = "maintenance-type-new.php?co_acc=$co_acc";
$url3 = "maintenance-type-edit.php";
$url4 = "maintenance-type-list-print.php";
$url5 = "maintenance-type-list-pdf.php";
$url6 = "maintenance-type-list-excel.php";
