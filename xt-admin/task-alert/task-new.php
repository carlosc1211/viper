...
$tit1 = "Task Alerts";
$tit2 = "New Task Alerts";
$url1 = "task-list.php?co_acc=$co_acc";
$url2 = "task-new.php?co_acc=$co_acc";
?>
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma" enctype="multipart/form-data">
                                    ...
                                    <table class="table table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                <div class='input-group date' id='datetimepicker_0' style="width: 150px">
                                                    <input type='text' class="form-control " name="fe_task_0" id="fe_task_0" />
