...
$url3 = "emergency-service-edit.php";
$url4 = "emergency-service-list-print.php";
$url5 = "emergency-service-list-pdf.php";
$url6 = "emergency-service-list-excel.php";
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="x_panel">
                            ...
                            $_SESSION["rs"] = $emergencyservice->listar($db);
