...
$url2 = "employee-edit.php?co_acc=$co_acc&co=$codigo";
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_title">
                                <h2>Form <small> </small></h2>
                                 <a href="employee-edit-print.php?co=<?php echo $codigo ?>" target="_blank" class="btn btn-default pull-right"><i class="fa fa-print"></i> Print</a>
                                <div class="clearfix"></div>
                            </div>
                            <!--****************************************************************-->
                            ...
                            <div class="x_content">
                                ...
                                if(isset($_REQUEST["acc"]))
                                {
                                    ...
                                    {
                                        $result = $employee->eliminar($db,["co"=>$codigo]);
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        ...
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <div class="col-md-3">
                                                    <img src="../../images/employee/<?php echo $ds_img ?>" alt="" class="img-thumbnail">
                                                    <input type="hidden" id="imagen_2" name="imagen_2" value="<?php echo $ds_img?>">
                                                ...
                                                <div class="col-md-9">
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" onkeypress="return acceptJustNumber(event)" class="form-control" name="r_ds_id" id="r_ds_id" placeholder="Input Employee ID" value="<?php echo $ds_id ?>" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker1'>
                                                                <input type='text' class="form-control" name="r_fe_contrato" id="r_fe_contrato" value="<?php echo $fe_contrato ?>" />
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="r_nb" id="r_nb" placeholder="Input First Name" maxlength="70" value="<?php echo $nb ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label class="control-label" for="nb_2">Middle Name</label>
                                                            <input type="text" class="form-control" name="nb_2" id="nb_2" placeholder="Input Middle Name" maxlength="70" value="<?php echo $nb_2 ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            <label class="control-label" for="r_apll">Last Name</label>
                                                            <input type="text" class="form-control" name="r_apll" id="r_apll" placeholder="Input Last Name" maxlength="70" value="<?php echo $apll ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="r_ciudad" id="r_ciudad" placeholder="Input City" value="<?php echo $ciudad ?>" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="r_ds_zip" id="r_ds_zip" placeholder="Input Zip" maxlength="5" value="<?php echo $ds_zip ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker2'>
                                                                <input type='text' class="form-control" name="r_fe_nac" id="r_fe_nac"  value="<?php echo $fe_nac ?>"/>
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <select name="r_co_sexo" class="form-control" id="r_co_sexo">
                                                                ...
                                                                foreach($rs as $rss)
                                                                {
                                                                    extract($rss);
                                                                    ?>
                                                                    <option value="<?php echo $co ?>" <?php if($co==$co_sexo) echo "selected"?>><?php echo $nb ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                        ...
                                                        <div class="form-group ">
                                                            ...
                                                            <select name="r_co_etnia" class="form-control" id="r_co_etnia">
                                                                ...
                                                                foreach($rs as $rss)
                                                                {
                                                                    extract($rss);
                                                                    ?>
                                                                    <option value="<?php echo $co ?>" <?php if($co==$co_etnia) echo "selected"?>><?php echo $nb ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <select name="r_co_language[]" multiple="true" size="4" class="form-control" id="r_co_language[]">
                                                                <?php
                                                                ...
                                                                foreach($rs as $rss)
                                                                {
                                                                    ...
                                                                    ?>
                                                                    <option value="<?php echo $co ?>" <?php if($posicion!==false) echo "selected"?>><?php echo $nb ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                            <div id="dlanguage_otro" style="display: none">
                                                                <br>
                                                                <input type="text" name="language_other"placeholder="Input Other Language" value="<?php echo $lenguaje_otro?>" class="form-control" name="language_other" maxlength="50">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group ">
                                                            ...
                                                            <select name="r_co_citizen_stat" class="form-control" id="r_co_citizen_stat">
                                                                ...
                                                                foreach($rs as $rss)
                                                                {
                                                                    extract($rss);
                                                                    ?>
                                                                    <option value="<?php echo $co ?>" <?php if($co==$co_citizen_stat) echo "selected"?>><?php echo $nb ?></option>
                                                                    <?php
                                                                }
                                                                ?>
                                                            </select>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="r_correo" id="r_correo" value="<?php echo $corr ?>" placeholder="Input Email" maxlength="150" onBlur="javascript:validaemail2('forma','r_correo')">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label" for="telf_casa">Phone (Home)</label>
                                                        <input type="text" class="form-control" name="telf_casa" id="telf_casa" value="<?php echo $telf_casa ?>" placeholder="Input Phone (Home)" maxlength="50">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="fax" id="fax" value="<?php echo $telf_fax ?>" placeholder="Input FAX" maxlength="50">
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <br>
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        ...
                                                        <input type="text" class="form-control" name="r_nb_contact" value="<?php echo $nb_contact ?>" id="r_nb_contact" placeholder="Input First Name" maxlength="70">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label" for="r_parentesco_contact">Relationship</label>
                                                        <input type="text" class="form-control" name="r_parentesco_contact" value="<?php echo $parentesco_contact ?>" id="r_parentesco_contact" placeholder="Input First Name" maxlength="70">
                                                    </div>
                                                </div>
                                                <div class="col-md-4">
                                                    <div class="form-group ">
                                                        <label class="control-label" for="r_telf_contact">Phone</label>
                                                        <input type="text" class="form-control" name="r_telf_contact" id="r_telf_contact" value="<?php echo $telf_contact ?>" placeholder="Input Phone (Contact)" maxlength="50">
                                                    </div>
                                                </div>
                                                <div class="clearfix"></div>
                                                <br>
                                                ...
                                                <div class="well well-sm">
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" value="<?php echo $lic_manejo_ds ?>" name="lic_manejo_ds" id="lic_manejo_ds" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker3'>
                                                                <input type='text' class="form-control" value="<?php echo $lic_manejo_fe_ini ?>" name="lic_manejo_fe_ini" id="lic_manejo_fe_ini" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker4'>
                                                                <input type='text' class="form-control" value="<?php echo $lic_manejo_fe_fin ?>" name="lic_manejo_fe_fin" id="lic_manejo_fe_fin" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="well well-sm">
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="r_lic_unarmed_ds" value="<?php echo $lic_unarmed_ds ?>" id="r_lic_unarmed_ds" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker5'>
                                                                <input type='text' class="form-control" name="r_lic_unarmed_fe_ini" value="<?php echo $lic_unarmed_fe_ini ?>" id="r_lic_unarmed_fe_ini" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker6'>
                                                                <input type='text' class="form-control" name="r_lic_unarmed_fe_fin" id="r_lic_unarmed_fe_fin" value="<?php echo $lic_unarmed_fe_fin ?>" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="well well-sm">
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="lic_armed_ds" id="lic_armed_ds" value="<?php echo $lic_armed_ds ?>" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker7'>
                                                                <input type='text' class="form-control" name="lic_armed_fe_ini" id="lic_armed_fe_ini"  value="<?php echo $lic_armed_fe_ini ?>"/>
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker8'>
                                                                <input type='text' class="form-control" name="lic_armed_fe_fin" id="lic_armed_fe_fin"  value="<?php echo $lic_armed_fe_fin ?>"/>
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="well well-sm">
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="lic_firearm_ds" id="lic_firearm_ds" value="<?php echo $lic_firearm_ds ?>" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker9'>
                                                                <input type='text' class="form-control" name="lic_firearm_fe_ini" id="lic_firearm_fe_ini" value="<?php echo $lic_firearm_fe_ini ?>" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker10'>
                                                                <input type='text' class="form-control" name="lic_firearm_fe_fin" id="lic_firearm_fe_fin" value="<?php echo $lic_firearm_fe_fin ?>" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                ...
                                                <div class="well well-sm">
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <input type="text" class="form-control" name="lic_firstaid_ds" id="lic_firstaid_ds" value="<?php echo $lic_firstaid_ds ?>" maxlength="50">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker11'>
                                                                <input type='text' class="form-control" name="lic_firstaid_fe_ini" id="lic_firstaid_fe_ini" value="<?php echo $lic_firstaid_fe_ini ?>" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group ">
                                                            ...
                                                            <div class='input-group date' id='datetimepicker12'>
                                                                <input type='text' class="form-control" name="lic_firstaid_fe_fin" id="lic_firstaid_fe_fin" value="<?php echo $lic_firstaid_fe_fin ?>" />
                                                                <span class="input-group-addon">
                                                                    <span class="glyphicon glyphicon-calendar"></span>
                                                                </span>
                                                            </div>
                                                    ...
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="r_co_stat_employee" class="form-control" id="r_co_stat_employee">
                                                            ...
                                                            foreach($rs as $rss)
                                                            {
                                                                extract($rss);
                                                                ?>
                                                                <option value="<?php echo $co ?>" <?php if($co==$co_stat_employee) echo "selected" ?>><?php echo $nb ?></option>
                                                                <?php
                                                            }
                                                            ?>
                                                        </select>
