...
$tit1 = "States";
$tit2 = "Edit State";
$url1 = "state-list.php?co_acc=$co_acc";
$url2 = "state-edit.php?co_acc=$co_acc&co=$codigo";
?>
                        ...
                        <div class="x_panel">
                            ...
                            <div class="x_content">
                                ...
                                if(isset($_REQUEST["acc"]))
                                {
                                    ...
                                    {
                                        $result = $state->eliminar($db,["co"=>$codigo]);
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="r_nb" id="r_nb" placeholder="Input State" value="<?php echo $nb ?>" maxlength="70">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="r_abrev">Abbreviation</label>
                                        <input type="text" class="form-control" name="r_abrev" id="r_abrev" placeholder="Input State Abbreviation" value="<?php echo $abrev ?>" maxlength="10">
                                    </div>
                                    <div class="form-group ">
