...
$url2 = "state-new.php?co_acc=$co_acc";
?>
                            ...
                            <div class="x_content">
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    <div class="form-group ">
                                        ...
                                        <input type="text" class="form-control" name="r_nb" id="r_nb" placeholder="Input State" maxlength="70">
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="r_abrev">Abbreviation</label>
                                        <input type="text" class="form-control" name="r_abrev" id="r_abrev" placeholder="Input State Abbreviation" maxlength="10">
                                    </div>
                                    <div class="form-group ">
