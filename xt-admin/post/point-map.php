...
$post = new PostModel();
$rs = $post->obtener_point_activos($db,$codigo);
$rsgeo = $post->obtener_geopoint($db,$codigo);
                            ...
                            <div class="x_content">
                                <div id="map_in" style="height: 360px"></div>
                                    ...
                                    <ul class="list-inline">
                                        <li><img src="http://maps.google.com/mapfiles/ms/icons/red.png" alt=""><strong>GEO Fence Corners</strong></li>
                                        <li><img src="http://maps.google.com/mapfiles/ms/icons/blue.png" alt=""><strong>Check Points</strong></li>
                                    </ul>
                            </div>
