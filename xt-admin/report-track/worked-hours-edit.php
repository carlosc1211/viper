                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Officer Tracker List</a></li>
                                            <li role="presentation"><a href="#tab_content2" id="home-tab2" role="tab" data-toggle="tab" aria-expanded="true">To Do Tracker List</a></li>
                                        </ul>
                                        <div id="myTabContent" class="tab-content">
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <table class="table">
                                                    ...
                                                    ?>
                                                        <tr>
                                                            <td><?php echo $nb_point ?></td>
                                                            <td><?php echo $fe_reg_track ?></td>
                                                            <td><a href="point-map.php?co_track=<?php echo $co ?>" class="btn btn-dark btn-xs iframe" data-toggle="tooltip" data-placement="top" title="View in Map"><i class="fa fa-map-marker"></i></a></td>
                                                        </tr>
                                                    <?php  
                                                    }
                                                    ?>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="home-tab2">
                                                <div class="col-md-12 col-xs-12">
                                                <?php  
                                                $rs = $track->obtenerToDoTracker($db,$codigo);  
                                                ...
                                                <?php    
                                                    ...
                                                    echo '<div class="alert alert-danger" role="alert"><p>Not To Do List Track registered</p></div>';
                                                    ?>
                                                </div>
