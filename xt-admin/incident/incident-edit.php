                                    ...
                                    if(getA("acc")=="ing")
                                    {
                                        $result = $incident->actualizar($db,
                                            [
                                                ...
                                                "co_incident_stat"=>getA("r_co_incident_stat"),
                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab" data-toggle="tab" aria-expanded="true">Main</a>
                                            </li>
                                            ...
                                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content1" aria-labelledby="home-tab">
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="r_co_incident_stat" class="form-control" id="r_co_incident_stat">
                                                            <option value="" selected>Select</option>
                                                            <?php
                                                ...
                                                <div class="bg-success">
                                                    ...
                                                    <table class="table table-hover">
                                                        ...
                                                        {   $i = 0;
                                                            ...
                                                            foreach($rs_prop as $prop_rs)
                                                            {
                                                                ...
                                                                <tr id="prop_<?php echo $i ?>">
                                                                    <th><input type="text" class="form-control" name="prop_dir_<?php echo $i ?>" id="prop_dir_<?php echo $i ?>" maxlength="255" value="<?php echo $prop_dir ?>"></th>
                                                                    <th><input type="text" class="form-control" name="prop_ciudad_<?php echo $i ?>" id="prop_ciudad_<?php echo $i ?>" maxlength="50" value="<?php echo $prop_ciudad ?>"></th>
                                                                    <th><input type="text" class="form-control" name="prop_state_<?php echo $i ?>" id="prop_state_<?php echo $i ?>" maxlength="50" value="<?php echo $prop_state ?>"></th>
                                                                    <th><input type="text" class="form-control" name="prop_zip_<?php echo $i ?>" id="prop_zip_<?php echo $i ?>" maxlength="10" value="<?php echo $prop_zip ?>"></th>
                                                                    <?php if($i==0) { ?>
                                                                        <th><a href="javascript:addProp()" class="btn btn-dark"><i class="fa fa-plus"></i> Add</a></th>
                                                                    <?php } else { ?>
                                                                        <th><a href="javascript:delPoint('prop_<?php echo $i ?>')" class="btn btn-danger"><i class="fa fa-trash"></i> Del</a></th>
                                                                    <?php } ?>
                                                                </tr>
                                                                <?php
                                                                $i++;
                                                        ...
                                                        else
                                                        {
                                                            ?>
                                                            <tr>
                                                                <th><input type="text" class="form-control" name="prop_dir_0" id="prop_dir_0" maxlength="255"></th>
                                                                <th><input type="text" class="form-control" name="prop_ciudad_0" id="prop_ciudad_0" maxlength="50"></th>
                                                                <th><input type="text" class="form-control" name="prop_state_0" id="prop_state_0" maxlength="50"></th>
                                                                <th><input type="text" class="form-control" name="prop_zip_0" id="prop_zip_0" maxlength="10"></th>
                                                                <th><a href="javascript:addProp()" class="btn btn-dark"><i class="fa fa-plus"></i> Add</a></th>
                                                            </tr>
                                                            <?php
                                                        }
