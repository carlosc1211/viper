                                ...
                                <form role="form" action="<?php echo $url2;?>" method="post" name="forma" id="forma">
                                    ...
                                    <div class="" role="tabpanel" data-example-id="togglable-tabs">
                                        <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                                            ...
                                            <li role="presentation" class=""><a href="#tab_content3" role="tab" id="profile-tab" data-toggle="tab" aria-expanded="false">IR Details</a>
                                            </li>
                                        </ul>
                                                ...
                                                <div class="col-md-6 col-xs-12">
                                                    <div class="form-group ">
                                                        ...
                                                        <div class='input-group date' id='datetimepicker1'>
                                                            <input type='text' class="form-control" name="r_fe_incident" id="r_fe_incident" />
